...
翻开题目，发现第一题是简单的凯撒密码，作为信息安全专业本科生，拿起键盘便开敲，敲到一半发现不对劲，为什么这个题目是中文的？正当我们愣住的时候，队友传来最后一题只要输出即可，于是快速注释一发写了个puts就过了，接着写A，发现怎么也不对（指完全逆序），感到奇怪，加了reverse跟没加一样，最后发现我的reverse是在scanf前写的……深感智障，改完后AC，暂列第11名。
